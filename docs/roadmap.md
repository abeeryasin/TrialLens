...
**Step 8, Explore, is underway** — units 1 (shape) and 2 (extraction) are
done; see the step 8 row above and `docs/decisions.md`, 2026-09-03. Next is
unit 3 (the merge step, against the unmerged baseline now on file) and then
the Explore endpoint and page.

...
| 7 | AI ranking/evidence layer ("potential fit" screening, visible evidence + uncertainty, eval harness built alongside) | **In progress.** Units 1-3 built 2026-08-30, then the endpoint was rebuilt 2026-08-31 after 8 real bugs surfaced — see `docs/STEP7_SESSION_SUMMARY.md` and the 2026-08-31 entries in `docs/decisions.md`. Five of eight signals now run in plain code, three in the model; 103 free tests pass, including every deterministic scorer against all 11,474 real trials. **Next: Unit 4, the Streamlit ranking page — nothing renders yet.** Working under a hard $5 API budget, $0.55 spent | 10-14 |
